...
urlpatterns = [
    path('', views.tour_list, name='tour_list'),  # For listing tours
    ...
    path('tourist_bookings/', views.view_bookings_in_profile, name='tourist_bookings'),
    path('bookings_of_guide/', views.guide_profile_bookings, name='bookings_of_guide'),
